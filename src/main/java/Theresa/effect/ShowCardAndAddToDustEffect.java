...
public class ShowCardAndAddToDustEffect extends AbstractGameEffect {
    private static final float EFFECT_DUR = 0.8F;
    private AbstractCard card;
    private static final float PADDING;

    public ShowCardAndAddToDustEffect(AbstractCard card, float offsetX, float offsetY) {
        this.card = card;
        ...
        DustPatch.dustManager.addCard(card);
    ...
    public ShowCardAndAddToDustEffect(AbstractCard card) {
        this.card = card;
